...
//
// Параметры:
//  КодыТиповОбработки  - Массив из Перечисление.КодыТиповОбработки - Любой код типа обработки, кроме Хаб
...
//
// Параметры:
//  КодТипаОбработки  - Перечисление.КодыТиповОбработки - Любой код типа обработки, кроме Хаб
//  МесяцСреза  - Дата - Любая дата месяца из корого нужно получить тариф
//
// Возвращаемое значение:
