...
//   Массив[Строка]  - Содержимое текстового файла в виде массива
//
...
//
// Параметры:
//  ДанныеИзФайла  - Массив[Строка] - Полный путь к файлу  
//  РазмерКорзины  - Число - количество элементов каждой части
//
// Возвращаемое значение:
//   Массив[Массив[Строка]]  - Список списков строк загружаемого файла
//
